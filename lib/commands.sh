...
export ASDF_PLUGIN_APP_NAME="helm"
export ASDF_PLUGIN_APP_REPO="https://github.com/helm/helm"
export ASDF_PLUGIN_APP_OUTPUT="helm"
export ASDF_PLUGIN_NAME="asdf-helm"
export ASDF_PLUGIN_REPO="https://github.com/kc-workspace/asdf-helm"
